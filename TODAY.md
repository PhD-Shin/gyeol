...
- [x] Gmail: `gyeol.project@gmail.com`
- [x] YouTube 채널 생성: 결 GYEOL
- [x] 프로필 이미지 (청록 붓터치 뿔)
- [x] 배너 이미지 (청록 수평선 글로우)
- [x] 채널 설명 작성
...
#### 🅱️ Style B — 판타지 팝 강조 (접근성 최대)

**Style of Music 복사:** (695자)
```
...
| 추임새 | 타입 | 위치 | 효과 |
|--------|------|------|------|
| **얼쑤 (Eolssu)** | 전통 | Intro, Drop | 폭발, 정체성 |
| **좋다 (Yeah)** | 전통+영어 | Pre-Chorus, Drop | 확인, 만족 |
| **그렇지** | 전통 | Drop | 동의, 강조 |
| **가자** | 현대 | Drop 끝 | 전진, 에너지 |
...
### Step 2: 음악 분석 (음악 완성 후)

> **원칙**: 가사와 직접 연관 없이, **음악 분위기**에 맞춰 비주얼을 만든다.

음악 들으면서 아래 채우기:

```
전체 무드: _____________ (긴장/고요/폭발/신비/공허)
...
필수 문서 3개 인쇄용 정리본:
- [[docs/99_meta/ESSENTIAL_READING]]
